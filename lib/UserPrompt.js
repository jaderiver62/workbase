...
const menu = () => {
    inquirer.prompt({
        ...
        choices: [
            ...
            "View Departments", "View Roles", "View Employees", "View Employee By Manager",
            "Update Employee", "Update Employee's Manager", "Exit"
        ]
    }).then(({
        choice
    }) => {
...
const employeeByManager = () => accessDatabase(`SELECT CONCAT(m.first_name, " ", m.last_name) AS "manager",  CONCAT(e.first_name, " ", e.last_name) AS "employee",  title, name AS "department"
